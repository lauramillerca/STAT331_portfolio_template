...
-   `semi_join()` : Lab 5 – revised to change inner_join() to semi_join() and to change as.Date to ymd, semi_join() is appropriate because
...
-   `anti_join()` : lab 5 – revised to change inner_join() to anti_join() and to change as.Date to ymd, anti_join() is appropriate because
